"""Complete the grids the recovered names are shaped like.
    ...
    python scripts/family_grid.py --audit          rank the families, emit nothing
    python scripts/family_grid.py --top 8          how many families to fill
    python scripts/family_grid.py | confirm_list - --label "family grid" --script scripts/family_grid.py
