"""The beginnings `data/prefixes.txt` cannot express, measured off the corpus.
    ...
    python scripts/uncarried_beginnings.py --audit     rank them, write nothing
    python scripts/uncarried_beginnings.py --top 3000  how many to carry
...
covers. This list is meant to be crossed with stems from **outside** -- another title's corpus,
strings scraped from a build, anything not already in the tables. The beginning list being capped
