"""What the *unnamed* names look like -- read off the ones this project has already recovered.
    ...
    python scripts/unnamed_profile.py            the profile and the over-represented affixes
    python scripts/unnamed_profile.py --grid     which families are grid-shaped and how sparse
