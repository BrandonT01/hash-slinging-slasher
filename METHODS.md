...
| — | *Modern Warfare 2019 methods (26–29) reach `image` and `material` only, Cold War's two best-covered pools. Together they returned 412 names for 58.8 T candidates on 2026-08-23 — **1 per 142.6 billion**, against 1 per 7.0 billion for the sound-alias ground. Read* `contrib/unnamed_profile.py` *before choosing one.* |
